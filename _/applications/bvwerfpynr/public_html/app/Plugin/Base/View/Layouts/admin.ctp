        ...
        <div id="wrapper" >            
            <header id="header">
                ...
                <div class="brand" style="text-align: center">
                    <a href="/" class="">
                        <?php echo $this->Html->image('logo_negro.png',array('style'=>'margin-top:8px','width'=>'130px')); ?>
                    </a>
                ...
                <ul class="nav navbar-nav navbar-left">
                    ...
                    <li class="hidden-xs hidden-sm">
                        <form method="post" action="/clientes">
                            <input class="search" name="data[nombre]" placeholder="Buscar Cliente" type="text">
