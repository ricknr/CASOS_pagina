...
<div class="row">
	...
	?>
		<div class="col-sm-4  required">
			...
			<div class="input-group">
			    ...
			    <input name="data[Caso][importe_meta]" class="form-control" step="0.01" type="number" id="CasoImporteMeta" required="required">
			</div>
		</div>
	...
	?>
		...
		<?php echo $this->Form->input('descripcion_resolucion', array( 'type'=>'textarea','label'=>'Descripción de la resolución','maxlength'=>100,'div'=>array('class'=>'col-sm-12 ' )) );?>
		<div class="col-md-12">
