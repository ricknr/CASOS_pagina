...
'.$status.'
	...
	{		
		...
		$content.='<div style="margin-top:20px;"><button id="confirm-button" name="confirm-button" onclick="closeFeatherBox();" align="center" class="btn btn-special btn-lg"><i class="fa fa-plus-circle"></i> Cerrar</button></div>';
	...
	<form id="donaciones" name="donaciones" method="POST" action="">
		...
		<div class="col-12">
			<div class="step mb-2">
				<h4><span>1</span> Selecciona la cantidad que deseas donar</h4>
				<ul class="quantity_select">
					<li data-qty="100" class="qty"><i class="fa fa-heart"></i> <strong>$1000</strong></li>
					<li data-qty="300" class="qty selected"><i class="fa fa-heart"></i> <strong>$300</strong></li>
					<li data-qty="500" class="qty"><i class="fa fa-heart"></i> <strong>$500</strong></li>
				</ul>';
