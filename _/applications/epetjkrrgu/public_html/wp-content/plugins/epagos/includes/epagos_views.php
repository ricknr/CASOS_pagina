...
if ( !class_exists( 'EpagosModule_Views' ) ) {
	...
	class EpagosModule_Views {
		...
		public static function options_page_panes( $options, $config ) {
			...
			foreach ( $options as $option ) {
				...
				if ( isset( $option['callback'] ) && is_callable( $option['callback'] ) ) $panes[] = call_user_func( $option['callback'], $option, $config );
