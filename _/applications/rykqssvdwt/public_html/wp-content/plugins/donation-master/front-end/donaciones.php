...
'.$status.'
	<form id="donaciones_form" name="donaciones_form" method="POST" action="">
		...
		<div class="row">
		<div class="col-12 col-lg-4 test1">
			<div class="step mb-2">
		...
		<div class="col-12 col-lg-8 test2">
			<div class="step mb-2">
	...
	if(($_GET['payment_status'] == 'success' || $_GET['payment_status'] == 'pending') && $_GET['order_id'])
	{
		$content .='<div class="lightbox" id="donation_confirmation_box">
						...
						$content.='<div style="margin-top:20px;"><button id="confirm-button aprobado" name="confirm-button" onclick="closeFeatherBox();" align="center" class="btn btn-special btn-lg"><i class="fa fa-heart"></i>&nbsp;Aceptar</button></div>';
