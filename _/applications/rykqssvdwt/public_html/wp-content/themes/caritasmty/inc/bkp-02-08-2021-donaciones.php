	...
	<form id="donaciones_form" name="donaciones_form" class="ssss" method="POST" action="">
				...
				<div class="row card-js">
					<div class="col-12 col-md-6 col-xl-7">
						...
						<ul class="paypment-options list-inline">
							<li class="list-inline-item"><img src="'.get_stylesheet_directory_uri().'/images/payment-visa.png" alt="icono metodo de pago"></li>
							<li class="list-inline-item"><img src="'.get_stylesheet_directory_uri().'/images/payment-mastercard.png" alt="icono metodo de pago"></li>
							<li class="list-inline-item" alt="icono metodo de pago"><img src="'.get_stylesheet_directory_uri().'/images/payment-amex.png"></li>
						</ul>
        ...
        <div class="col-12 col-md-6 col-lg-4 payment_cards text-center">
            <div class="payment-options">
                <img src="'.get_stylesheet_directory_uri().'/images/payment.png">
            </div>
            <div class="secure">
                <img src="'.get_stylesheet_directory_uri().'/images/secure.png">
