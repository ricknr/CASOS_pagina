		...
		$content .= '<div class="homepage_grid mb-4 pb-4 row '.$class.'">';
			...
			foreach ($homepage_grid_query as $item) {
				...
				if ($counter < 3){
					...
					<div class="row">
					<div class="image col-sm-6 mb-3 mb-md-2"><a href="'.get_permalink($item['post_id']).'" class="d-block" ><img src="'.$item['post_thumbnail_vertical'].'" class="img-fluid" alt="obras de caritas"></a> <a href="'.$item['term_link'].'" class="category '.$item['category_slug'].'">';
					...
					<div class="row">
					<div class="image col-12 mb-3 mb-md-2"><a href="'.get_permalink($item['post_id']).'" class="d-block" ><img src="'.$item['post_thumbnail'].'" class="img-fluid" alt="imagen portada"></a>';
					$content .= '<a href="'.$item['term_link'].'" class="category '.$item['category_slug'].'">';
					if ($item['category_icon']) {
						$content .= '<img src="'.$item['category_icon'].'" class="img-fluid" alt="iconos de obras">';
					}
					$content .= $item['category'].'</a> </div>
