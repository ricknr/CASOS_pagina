...
if($style == 'horizontal') { 
	...
	{	
		...
		if($_REQUEST['error']!='')
		{
			$status .='<div>Mensaje de error : '.stripslashes(urldecode($_REQUEST['error'])).'</div>';	
		}
...
'.$status.'
	<form id="donaciones_form" name="donaciones_form" class="ssss" method="POST" action="">
		...
		<input type="hidden" name="donate_page_url" id="donate_page_url" value="'.get_permalink().'">
				...
				<div class="row card-js">
					<div class="col-12 col-md-6 col-xl-7">
						...
						<ul class="paypment-options list-inline">
							<li class="list-inline-item"><img src="'.get_stylesheet_directory_uri().'/images/payment-visa.png" alt="logo visa"></li>
							<li class="list-inline-item"><img src="'.get_stylesheet_directory_uri().'/images/payment-mastercard.png" alt="logo mastercard"></li>
							<li class="list-inline-item"><img src="'.get_stylesheet_directory_uri().'/images/payment-amex.png" alt="logo american express"></li>
						</ul>
        ...
        <div class="col-12 col-md-6 col-lg-4 payment_cards text-center">
            <div class="payment-options">
                <img src="'.get_stylesheet_directory_uri().'/images/payment.png" alt="logos metodos de pago">
            </div>
            <div class="secure">
                <img src="'.get_stylesheet_directory_uri().'/images/secure.png" alt="icono pago seguro">
	...
	{		
		...
		if($_REQUEST['error']!='')
		{
			$content .='<div>Mensaje de error : '.stripslashes(urldecode($_REQUEST['error'])).'</div>';	
		}
