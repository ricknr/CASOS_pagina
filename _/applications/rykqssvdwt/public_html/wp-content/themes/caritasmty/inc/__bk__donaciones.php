	...
	<form id="donaciones" name="donaciones" method="POST" action="">
			...
			<div class="step mb-2">
				...
				<div class="row card-js">
					...
					<div class="col-6 col-md-4 col-xl-3">
						...
						<div class="sctn-col half l" style="float:left">
							<input type="text" maxlength="2" class="form-control" placeholder="Mes" data-openpay-card="expiration_month" style="width:60px">
						</div>
	                    <div class="sctn-col half l" style="float:left;margin-left:20px;">
	                    	<input type="text" maxlength="2" class="form-control" placeholder="Año" data-openpay-card="expiration_year" style="width:60px">
	                    </div>
		...
		<div class="col-12 text-center">
			...
			<div class="text-center" style="padding-top:5px">			
				<a id="openbox" href="#donation_unsubscribe_box">Cancelar la donación</a>
			</div>
		</div>	
		</div>
	...
	if(($_GET['payment_status'] == 'success') && $_GET['order_id'])
	{
		$content .='<div class="lightbox" id="donation_confirmation_box">
						<div id="donation_confirmation_div" style="padding:10px;text-align:left;">							
								<div><b>Su donación se procesa con éxito. Gracias por su apoyo.</b></div>
								<br/>
