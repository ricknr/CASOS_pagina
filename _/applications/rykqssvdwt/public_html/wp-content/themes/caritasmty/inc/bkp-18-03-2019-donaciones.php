...
'.$status.'
	<form id="donaciones_form" name="donaciones_form" method="POST" action="">
				...
				<div class="row card-js">
					<div class="col-12 col-md-6 col-xl-7">
						...
						<ul class="paypment-options list-inline">
							...
							<li class="list-inline-item"><img src="'.get_stylesheet_directory_uri().'/images/payment-amex.png" alt="icono metodo de pago"></li>
						</ul>
