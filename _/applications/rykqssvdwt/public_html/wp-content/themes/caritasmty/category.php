...
<div id="content">
	...
	<div class="container">
        <div class="row justify-content-center pt-4 pb-4">
    		<div class="col-4 col-md-2 text-center"><div class="category-icon"><?php if ($category_icon){ echo '<img src="'.$category_icon.'" alt="icono de categorias de las notas">';}?></div></div>
		...
		<div class="row">
			...
			<div class="col-12 text-center share mt-4 mb-4">
				...
				echo do_shortcode('[easy-social-share buttons="facebook,twitter,whatsapp" counters=0 style="icon" template="18" animation="pop" point_type="simple" url="'.$url.'" text="'.$title.'"]'); ?> 
			</div>
